...
const TOKEN_KEY = "marteller-token";

// Uploaded files (template images, profile photos, ...) come back from the
// API as backend-relative paths — resolve them to a fetchable URL.
